...
import bug.frontstage.project_info.service.RefuseService;

@Service("RefuseServiceimp")
public class RefuseServiceimp  implements RefuseService  {
	...
	public void refuse(String buser_name, String reason, int bug_id, String content, int bid, String photo, String fu,String fu_name) {
		selectProgram.refuse(buser_name, reason, bug_id, content, bid, photo, fu, fu_name);
